...
namespace Validation.Validation
{
    public class PaymentVoucherValidator : IPaymentVoucherValidator
    {
        ...
        public PaymentVoucher VTotalAmountIsNotZero(PaymentVoucher paymentVoucher, IPaymentVoucherDetailService _paymentVoucherDetailService)
        {
            ...
            {
                totalamount += detail.AmountUSD + detail.AmountIDR;
            }
            if (totalamount == 0)
            {
        ...
        //public PaymentVoucher VGeneralLedgerPostingHasNotBeenClosed(PaymentVoucher paymentVoucher,  int CaseConfirmUnconfirmReconcileUnreconcile)
        //{
                                             ...
                                             IPayableService _payableService)
        {
            ...
            if (!isValid(paymentVoucher)) { return paymentVoucher; }
            //VGeneralLedgerPostingHasNotBeenClosed(paymentVoucher, 1);
            return paymentVoucher;
        }
        ...
        public PaymentVoucher VUnconfirmObject(PaymentVoucher paymentVoucher)
        {
            ...
            if (!isValid(paymentVoucher)) { return paymentVoucher; }
            //VGeneralLedgerPostingHasNotBeenClosed(paymentVoucher, 2);
            return paymentVoucher;
        }

        public PaymentVoucher VReconcileObject(PaymentVoucher paymentVoucher, IPaymentVoucherDetailService _paymentVoucherDetailService, ICashBankService _cashBankService)
        {
            ...
            if (!isValid(paymentVoucher)) { return paymentVoucher; }
           // VGeneralLedgerPostingHasNotBeenClosed(paymentVoucher, 3);
           // if (!isValid(paymentVoucher)) { return paymentVoucher; }
        ...
        public PaymentVoucher VUnreconcileObject(PaymentVoucher paymentVoucher)
        {
            ...
            if (!isValid(paymentVoucher)) { return paymentVoucher; }
            //VGeneralLedgerPostingHasNotBeenClosed(paymentVoucher, 4);
            return paymentVoucher;
        }
        ...
        public bool ValidReconcileObject(PaymentVoucher paymentVoucher, IPaymentVoucherDetailService _paymentVoucherDetailService, ICashBankService _cashBankService)
        {
            paymentVoucher.Errors.Clear();
            VReconcileObject(paymentVoucher, _paymentVoucherDetailService, _cashBankService);
            return isValid(paymentVoucher);
        }

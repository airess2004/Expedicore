...
namespace Validation.Validation
{
    public class ReceiptVoucherValidator : IReceiptVoucherValidator
    {
        ...
        public ReceiptVoucher VTotalAmountIsNotZero(ReceiptVoucher receiptVoucher, IReceiptVoucherDetailService _receiptVoucherDetailService)
        {
            ...
            {
                totalamount += detail.AmountIDR + detail.AmountUSD;
            }
            if (totalamount == 0)
            {
        ...
        //    foreach (var detail in details)
        //    {
        //        detailsamount += detail.AmountUSD + detail.AmountIDR;
        //    }
        //    if (Math.Round(detailsamount, 2) != Math.Round(receiptVoucher.TotalAmountIDR, 2))
        //    {
        ...
        //public ReceiptVoucher VGeneralLedgerPostingHasNotBeenClosed(ReceiptVoucher receiptVoucher,  int CaseConfirmUnconfirmReconcileUnreconcile)
        //{
                                             ...
                                             IReceivableService _receivableService)
        {
            ...
            if (!isValid(receiptVoucher)) { return receiptVoucher; }
            //VGeneralLedgerPostingHasNotBeenClosed(receiptVoucher, 1);
            return receiptVoucher;
        }
                                               ...
                                               ICashBankService _cashBankService)
        {
            ...
            if (!isValid(receiptVoucher)) { return receiptVoucher; }
            //VGeneralLedgerPostingHasNotBeenClosed(receiptVoucher, 2);
            //if (!isValid(receiptVoucher)) { return receiptVoucher; }
        ...
        public ReceiptVoucher VReconcileObject(ReceiptVoucher receiptVoucher)
        {
            ...
            if (!isValid(receiptVoucher)) { return receiptVoucher; }
           // VGeneralLedgerPostingHasNotBeenClosed(receiptVoucher, 3);
            return receiptVoucher;
        }
                                                 ...
                                                 ICashBankService _cashBankService)
        {
            ...
            if (!isValid(receiptVoucher)) { return receiptVoucher; }
           // VGeneralLedgerPostingHasNotBeenClosed(receiptVoucher, 4);
            if (!isValid(receiptVoucher)) { return receiptVoucher; }
        ...
        public bool ValidUnconfirmObject(ReceiptVoucher receiptVoucher, IReceiptVoucherDetailService _receiptVoucherDetailService, ICashBankService _cashBankService)
        {
            receiptVoucher.Errors.Clear();
            VUnconfirmObject(receiptVoucher, _receiptVoucherDetailService, _cashBankService);
            return isValid(receiptVoucher);
        }
        ...
        public bool ValidUnreconcileObject(ReceiptVoucher receiptVoucher, IReceiptVoucherDetailService _receiptVoucherDetailService, ICashBankService _cashBankService)
        {
            receiptVoucher.Errors.Clear();
            VUnreconcileObject(receiptVoucher, _receiptVoucherDetailService, _cashBankService);
            return isValid(receiptVoucher);
        }

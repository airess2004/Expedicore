...
namespace Validation.Validation
{
    public class CashMutationValidator : ICashMutationValidator
    {
        ...
        {
            if (!cashMutation.SourceDocumentType.Equals(MasterConstant.SourceDocument.CashBankAdjustment) &&
                !cashMutation.SourceDocumentType.Equals(MasterConstant.SourceDocument.PaymentVoucher) &&
                !cashMutation.SourceDocumentType.Equals(MasterConstant.SourceDocument.ReceiptVoucher))
            {

...
namespace Validation.Validation
{
    public class CashMutationValidator : ICashMutationValidator
    {
        ...
        {
            if (!cashMutation.Status.Equals(MasterConstant.MutationStatus.Addition) &&
                !cashMutation.Status.Equals(MasterConstant.MutationStatus.Deduction))
            {
        ...
        {
            if (!cashMutation.SourceDocumentType.Equals(MasterConstant.SourceDocumentType.CashBankAdjustment) &&
                !cashMutation.SourceDocumentType.Equals(MasterConstant.SourceDocumentType.PaymentVoucher) &&
                !cashMutation.SourceDocumentType.Equals(MasterConstant.SourceDocumentType.ReceiptVoucher))
            {

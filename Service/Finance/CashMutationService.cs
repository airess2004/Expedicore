...
namespace Service.Service
{
    public class CashMutationService : ICashMutationService
    {
        ...
        {
            IList<CashMutation> cashMutations = _repository.GetObjectsBySourceDocument(cashBank.Id, MasterConstant.SourceDocumentType.PaymentVoucher, paymentVoucher.Id);
        ...
        public CashMutation CreateCashMutationForReceiptVoucher(ReceiptVoucher receiptVoucher, CashBank cashBank)
        {
            ...
            cashMutation.SourceDocumentType = MasterConstant.SourceDocumentType.ReceiptVoucher;
        ...
        public CashMutation CreateCashMutationForCashBankAdjustment(CashBankAdjustment cashBankAdjustment, CashBank cashBank)
        {
            ...
            cashMutation.SourceDocumentType = MasterConstant.SourceDocumentType.CashBankAdjustment;
        ...
        {
            IList<CashMutation> cashMutations = _repository.GetObjectsBySourceDocument(cashBank.Id, MasterConstant.SourceDocumentType.CashBankAdjustment, cashBankAdjustment.Id);
            foreach (var cashMutation in cashMutations)
            {
                _repository.Delete(cashMutation);
            }
        ...
        public IList<CashMutation> SoftDeleteCashMutationForCashBankMutation(CashBankMutation cashBankMutation, CashBank sourceCashBank, CashBank targetCashBank)
        {
            ...
            IList<CashMutation> sourceCashMutations = _repository.GetObjectsBySourceDocument(sourceCashBank.Id, MasterConstant.SourceDocumentType.CashBankMutation, cashBankMutation.Id);
            ...
            IList<CashMutation> targetCashMutations = _repository.GetObjectsBySourceDocument(targetCashBank.Id, MasterConstant.SourceDocumentType.CashBankMutation, cashBankMutation.Id);

...
namespace Service.Service
{
    public class CashMutationService : ICashMutationService
    {
        ...
        {
            IList<CashMutation> cashMutations = _repository.GetObjectsBySourceDocument(cashBank.Id, MasterConstant.SourceDocument.PaymentVoucher, paymentVoucher.Id);
        ...
        {
            IList<CashMutation> cashMutations = _repository.GetObjectsBySourceDocument(cashBank.Id, MasterConstant.SourceDocument.ReceiptVoucher, receiptVoucher.Id);
            foreach (var cashMutation in cashMutations)
            {
                _repository.Delete(cashMutation);
            }
        ...
        {
            IList<CashMutation> cashMutations = _repository.GetObjectsBySourceDocument(cashBank.Id, MasterConstant.SourceDocument.CashBankAdjustment, cashBankAdjustment.Id);
            foreach (var cashMutation in cashMutations)
            {
                _repository.Delete(cashMutation);
            }
        ...
        public IList<CashMutation> CreateCashMutationForCashBankMutation(CashBankMutation cashBankMutation, CashBank sourceCashBank, CashBank targetCashBank)
        {
            ...
            sourceCashMutation.SourceDocumentType = MasterConstant.SourceDocument.CashBankMutation;
            ...
            targetCashMutation.SourceDocumentType = MasterConstant.SourceDocument.CashBankMutation;
        ...
        public IList<CashMutation> SoftDeleteCashMutationForCashBankMutation(CashBankMutation cashBankMutation, CashBank sourceCashBank, CashBank targetCashBank)
        {
            ...
            IList<CashMutation> sourceCashMutations = _repository.GetObjectsBySourceDocument(sourceCashBank.Id, MasterConstant.SourceDocument.CashBankMutation, cashBankMutation.Id);
            ...
            IList<CashMutation> targetCashMutations = _repository.GetObjectsBySourceDocument(targetCashBank.Id, MasterConstant.SourceDocument.CashBankMutation, cashBankMutation.Id);
        ...
        {
            decimal Amount = (cashMutation.Status == MasterConstant.MutationStatus.Addition) ? cashMutation.Amount : (-1) * cashMutation.Amount;

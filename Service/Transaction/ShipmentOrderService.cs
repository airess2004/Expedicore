...
//shipmentorder.Truck = "";
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.EMKLDomestic, shipmentorder.JobNumber, shipmentorder.SubJobNumber);
        ...
        public ShipmentOrder CreateObjectEMKLAirImport(ShipmentOrder shipmentorder)//OfficeId && CreatedBy
        {
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.EMKLAirImport, shipmentorder.JobNumber, shipmentorder.SubJobNumber);
            shipmentorder = _repository.CreateObject(shipmentorder);
            return shipmentorder;
        }
        ...
        public ShipmentOrder CreateObjectEMKLAirExport(ShipmentOrder shipmentorder)//OfficeId && CreatedBy
        {
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.EMKLAirExport, shipmentorder.JobNumber, shipmentorder.SubJobNumber);
            shipmentorder = _repository.CreateObject(shipmentorder);
            return shipmentorder;
        }
        ...
        public ShipmentOrder CreateObjectEMKLSeaImport(ShipmentOrder shipmentorder)//OfficeId && CreatedBy
        {
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.EMKLSeaImport, shipmentorder.JobNumber, shipmentorder.SubJobNumber);
            shipmentorder = _repository.CreateObject(shipmentorder);
            return shipmentorder;
        } 

        public ShipmentOrder CreateObjectPPJK(ShipmentOrder shipmentorder)//OfficeId && CreatedBy
        {
            ShipmentOrder newshipmentOrder = new ShipmentOrder();
            newshipmentOrder.SubJobNumber = 0;
            newshipmentOrder.JobId = MasterConstant.JobType.PPJK;
            newshipmentOrder.JobStatus = "FCL";
            newshipmentOrder.SIDate = DateTime.Today;
            newshipmentOrder.LoadStatus = "FCL";
            newshipmentOrder.ShipmentStatus = "N";
            newshipmentOrder.ETD = DateTime.Today;
            newshipmentOrder.ETA = DateTime.Today;
            newshipmentOrder.OBLStatus = "P";
            newshipmentOrder.HBLStatus = "P";
            newshipmentOrder.GoodRecDate = DateTime.Today;
            newshipmentOrder.JobStatus = "FCL";
            newshipmentOrder.Currency = "USD";
            newshipmentOrder.HandlingInfo = "PLEASE CONTACT CONSIGNEE IMMEDIATELY UPON ARRIVAL";
            newshipmentOrder.CreatedAt = DateTime.Now;
            newshipmentOrder.MasterCode = _repository.GetLastMasterCode(shipmentorder.OfficeId) + 1;
            newshipmentOrder.JobNumber = _repository.GetLastJobNumber(shipmentorder.OfficeId, MasterConstant.JobType.PPJK) + 1;
            newshipmentOrder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.PPJK, newshipmentOrder.JobNumber, newshipmentOrder.SubJobNumber);
            newshipmentOrder.OfficeId = shipmentorder.OfficeId;
            newshipmentOrder.CreatedById = shipmentorder.CreatedById;
            shipmentorder = _repository.CreateObject(newshipmentOrder);
        ...
        public ShipmentOrder CreateObjectEMKLSeaExport(ShipmentOrder shipmentorder)//OfficeId && CreatedBy
        {
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.EMKLSeaExport, shipmentorder.JobNumber, shipmentorder.SubJobNumber);
            shipmentorder = _repository.CreateObject(shipmentorder);
            return shipmentorder;
        }
        ...
        public ShipmentOrder CreateObjectSeaExport(ShipmentOrder shipmentorder)//OfficeId && CreatedBy
        {
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.SeaExport,shipmentorder.JobNumber,shipmentorder.SubJobNumber);
            shipmentorder = _repository.CreateObject(shipmentorder);
            return shipmentorder;
        }
        ...
        public ShipmentOrder CreateObjectSeaImport(ShipmentOrder shipmentorder)//OfficeId && CreatedBy
        {
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.SeaImport, shipmentorder.JobNumber, shipmentorder.SubJobNumber);
            shipmentorder = _repository.CreateObject(shipmentorder);
            return shipmentorder;
        }
        ...
        public ShipmentOrder CreateObjectAirImport(ShipmentOrder shipmentorder) //OfficeId && CreatedBy && JobID
        {
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.AirImport, shipmentorder.JobNumber, shipmentorder.SubJobNumber);
            shipmentorder = _repository.CreateObject(shipmentorder);
            return shipmentorder;
        }
        ...
        public ShipmentOrder CreateObjectAirExport(ShipmentOrder shipmentorder) //OfficeId && CreatedBy && JobID
        {
            ...
            shipmentorder.ShipmentOrderCode = GenerateShipmentNo(shipmentorder.Office.InitialCompany, MasterConstant.JobType.AirExport, shipmentorder.JobNumber, shipmentorder.SubJobNumber);
            ...
            if (isValid(_validator.VCreateObject(shipmentorder,this)))
            {
                switch (shipmentorder.JobId)
                {
                    ...
                    case MasterConstant.JobType.PPJK:
                        shipmentorder = this.CreateObjectPPJK(shipmentorder);
                        break;
                }
        ...
        ShipmentOrderRouting shipmentorderrouting, IShipmentOrderRoutingService _shipmentorderroutingService)
        {
            ...
            if (subJobNo == 1)
            {
                ...
                newShipmentOrder.CreatedAt = DateTime.Now;
                newShipmentOrder.ShipmentOrderCode = GenerateShipmentNo(model.Office.InitialCompany, MasterConstant.JobType.AirImport, model.JobNumber, model.SubJobNumber);
        ...
        { 
            ...
            if (subJobNo == 1)
            {
                ...
                newShipmentOrder.CreatedById = model.CreatedById;
                newShipmentOrder.CreatedAt = DateTime.Now;
                newShipmentOrder.ShipmentOrderCode = GenerateShipmentNo(model.Office.InitialCompany, MasterConstant.JobType.AirExport, model.JobNumber, model.SubJobNumber);
        ...
        { 
                ...
                if (subJobNo == 1)
                {
                    ...
                    newShipmentOrder.CreatedById = model.CreatedById;
                    newShipmentOrder.CreatedAt = DateTime.Now;
                    newShipmentOrder.ShipmentOrderCode = GenerateShipmentNo(model.Office.InitialCompany, MasterConstant.JobType.SeaImport, model.JobNumber, model.SubJobNumber);
          ...
          ShipmentOrderRouting shipmentorderrouting, IShipmentOrderRoutingService _shipmentorderroutingService)
        {
            ...
            if (subJobNo == 1)
            {
                ...
                newShipmentOrder.CreatedById = model.CreatedById;
                newShipmentOrder.CreatedAt = DateTime.Now;
                newShipmentOrder.ShipmentOrderCode = GenerateShipmentNo(model.Office.InitialCompany, MasterConstant.JobType.SeaExport, model.JobNumber, model.SubJobNumber);

...
namespace Core.Interface.Service
{
    public interface IReceivableService
    {
        ...
        Receivable GetObjectBySource(string ReceivableSource, int ReceivableSourceId, int ReceivableSourceDetailId); 
        Receivable GetObjectById(int Id);
        Receivable CreateObject(Receivable receivable);
        Receivable CreateObject(int officeId, int contactId, string receivableSource, int receivableSourceId, int receivableSourceDetailId, int currencyId, decimal amount, decimal Rate, DateTime dueDate);

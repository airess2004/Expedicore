...
$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'Airline/GetList' }).trigger("reloadGrid");
    }
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "Airline/GetInfo?Id=" + id,
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'Airline/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'Airline/Insert';
        }
        ...
        $.ajax({
            ...
            url: submitURL,
            data: JSON.stringify({
                Id: id, Name: $("#Name").val(), Abbrevation: $("#Abbrevation").val()
            }),
            async: false,
            cache: false,
            timeout: 30000,

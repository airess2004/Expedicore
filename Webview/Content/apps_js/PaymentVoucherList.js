$(document).ready(function () {
    ...
    function ReloadGrid() {
        ...
        $("#list_paymentvoucher").setGridParam({ url: base_url + 'PaymentVoucher/GetList', postData: { filters: null, JobId: value }, page: 'last' }).trigger("reloadGrid");
    }
    ...
    $("#paymentvoucher_btn_edit, #paymentvoucher_btn_del").click(function () {
        ...
        if (pvid) {
            ...
            if (buttonID == "paymentvoucher_btn_edit") {
                window.location = base_url + "PaymentVoucher/Detail?Id=" + pvid + "&JobId=" + value;
            }
                // On Delete
            else {
                DeletePaymentVoucher(pvid);
            }
    ...
    function DeletePaymentVoucher(pvId) {
    ...
    function PrintPaymentVoucher(pvId) {
        window.open(base_url + "PaymentVoucher/Print?Id=" + pvId);
    }

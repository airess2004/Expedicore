...
$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'MstContainerYard/GetList' }).trigger("reloadGrid");
    }
    ...
    //GRID +++++++++++++++
    $("#list").jqGrid({
        url: base_url + 'MstContainerYard/GetList',
        datatype: "json",
        colNames: ['ID', 'Name', 'Address','Description', 'Created At', 'Updated At'],
        colModel: [
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "MstContainerYard/GetInfo?Id=" + id,
    ...
    $('#delete_confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "MstContainerYard/Delete",
            type: "POST",
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'MstContainerYard/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'MstContainerYard/Insert';
        }

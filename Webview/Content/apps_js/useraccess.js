$(document).ready(function () {
    ...
    function GetAccessUser() {
        $.ajax({
            dataType: "json",
            url: base_url + "AccessUser/GetAccessUser?UserId=" + usercode + "&groupName=" + group,
            success: function (result) {
                PopulateAccessUser(group, result);
            }
        });
    }

    function PopulateAccessUser(group, objAccessUser) {
        if (objAccessUser != null) {
            for (var i = 0; i < objAccessUser.listAccessUser.length; i++) {
                var newData = {};
                newData.code = objAccessUser.listAccessUser[i].MenuId;
                newData.name = objAccessUser.listAccessUser[i].Name;
                newData.read = objAccessUser.listAccessUser[i].View;
                newData.write = objAccessUser.listAccessUser[i].Create;
                newData.edit = objAccessUser.listAccessUser[i].Edit;
                newData.delete = objAccessUser.listAccessUser[i].Delete;
                newData.undelete = objAccessUser.listAccessUser[i].UnDelete;
                newData.print = objAccessUser.listAccessUser[i].Print;

                // New Record
                var group_menu = objAccessUser.listAccessUser[i].GroupName.toLowerCase();
    ...
    function UpdateAllowView(menuId, isAllow) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: base_url + "AccessUser/AllowView",
            data: JSON.stringify({
    ...
    function UpdateAllowEdit(menuId, isAllow) {
        ...
        $.ajax({
            contentType: "application/json",
            type: 'POST',
            url: base_url + "AccessUser/AllowEdit",
            data: JSON.stringify({
                UserId: userId, MenuId: menuId, IsAllow: isAllow
            }),
            success: function (result) {
    ...
    function UpdateAllowDelete(menuId, isAllow) {
        ...
        $.ajax({
            contentType: "application/json",
            type: 'POST',
            url: base_url + "AccessUser/AllowDelete",
            data: JSON.stringify({
                UserId: userId, MenuId: menuId, IsAllow: isAllow
            }),
            success: function (result) {
    ...
    function UpdateAllowUnDelete(menuId, isAllow) {
        ...
        $.ajax({
            contentType: "application/json",
            type: 'POST',
            url: base_url + "AccessUser/AllowUnDelete",
            data: JSON.stringify({
                UserId: userId, MenuId: menuId, IsAllow: isAllow
            }),
            success: function (result) {
    ...
    function UpdateAllowPrint(menuId, isAllow) {
        ...
        $.ajax({
            contentType: "application/json",
            type: 'POST',
            url: base_url + "AccessUser/AllowPrint",
            data: JSON.stringify({
                UserId: userId, MenuId: menuId, IsAllow: isAllow
            }),
            success: function (result) {
    ...
    function UpdateAllowCreate(menuId, isAllow) {
        ...
        $.ajax({
            contentType: "application/json",
            type: 'POST',
            url: base_url + "AccessUser/AllowCreate",
            data: JSON.stringify({
                UserId: userId, MenuId: menuId, IsAllow: isAllow
            }),
            success: function (result) {
    ...
    $('#ua_form_btn_save').click(function () {
        ...
        $.ajax({
            contentType: "application/json",
            type: 'POST',
            url: base_url + "AccessUser/SaveAccessUserType",
            data: JSON.stringify({
            ...
            success: function (result) {
                if (result.isValid) {
                    $.messager.alert('Information', result.message, 'info', function () {
                        window.location = base_url + "AccessUser";
                    });
                }
                else {
                    $.messager.alert('Warning', result.message, 'warning');

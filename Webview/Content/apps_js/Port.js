$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'Port/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    //GRID +++++++++++++++
    $("#list").jqGrid({
        url: base_url + 'Port/GetList',
        datatype: "json",
        colNames: ['Del','ID', 'Int. Code', 'Port Name', 'City Name', 'Country Name', 'Continent Name', 'Created At', 'Updated At'],
        colModel: [
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "Port/GetInfo?Id=" + id,
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'Port/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'Port/Insert';
        }

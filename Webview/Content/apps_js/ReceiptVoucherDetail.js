$(document).ready(function () {
    ...
    function FirstLoad() {
        ...
        $.ajax({
            dataType: "json",
            url: base_url + "ReceiptVoucher/GetInfo?Id=" + PVId,
                ...
                if (JSON.stringify(result.Errors) != '{}') {
                    for (var key in result.Errors) {
                        if (key != null && key != undefined && key != 'Generic') {
                            ...
                            window.location = base_url + "ReceiptVoucher";
                        }
                    }
                }
                else {
                    //$('#txtPVreference').val(result.Code);
                    $('#txtPVpaymentvoucherno').val(result.Code);
                    $('#txtPVbankcode').val(result.CashBankCode).data('kode', result.CashBankId);
                    $('#txtPVintbankname').val(result.CashBankName);
                    $('#txtPVbankname').val(result.Currency).data('kode', result.CurrencyId);
                    ...
                    $('#txtPVaddress').text(result.ContactAddress);

                    $('#txtPVcustomer').val(result.ContactCode).data('kode', result.ContactId);
                    $('#txtPVnmcustomer').val(result.ContactName);

                    // Payment Voucher Detail
                    if (result.ListReceiptVoucherDetail != null) {
                        if (result.ListReceiptVoucherDetail.length > 0) {
                            for (var i = 0; i < result.ListReceiptVoucherDetail.length; i++) {
                                AddPaymentDetail(0, result.ListReceiptVoucherDetail[i].Id,
                                    result.ListReceiptVoucherDetail[i].AccountId,
                                    result.ListReceiptVoucherDetail[i].AccountCode,
                                    result.ListReceiptVoucherDetail[i].AccountName,
                                    result.ListReceiptVoucherDetail[i].Description,
                                    result.ListReceiptVoucherDetail[i].DCNote,
                                    result.ListReceiptVoucherDetail[i].AmountUSD,
                                    result.ListReceiptVoucherDetail[i].AmountIDR,
                                    result.ListReceiptVoucherDetail[i].ReceivableCode,
                                    result.ListReceiptVoucherDetail[i].ShipmentOrderNo,
                                    result.ListReceiptVoucherDetail[i].RefRate,
                                    result.ListReceiptVoucherDetail[i].ExRateId,
                                    result.ListReceiptVoucherDetail[i].ShipmentOrderId,
                                    result.ListReceiptVoucherDetail[i].RemainingAmountUSD,
                                    result.ListReceiptVoucherDetail[i].RemainingAmountIDR,
                                   result.ListReceiptVoucherDetail[i].PaymentCash,
                                   result.ListReceiptVoucherDetail[i].ReceivableId,
                                   result.ListReceiptVoucherDetail[i].RefId,
                                   result.ListReceiptVoucherDetail[i].ReceivableId,
                                   result.ListReceiptVoucherDetail[i].PVBank);
                            }
                        }
                    }
                    CalculatePayment();
    ...
    $('#btnPVcustomer').click(function () {
        ...
        $('input[id*="gs_"]').val("");
            ...
            lookupGrid.setGridParam({ url: base_url + 'MstContact/GetLookUp', postData: { filters: null }, page: 'last' }).trigger("reloadGrid");
    ...
    $('#btnPVDrefno').click(function () {
        ...
        var listExistedInvoice = [];
            ...
            pvd_lookupUrl_settlement_for = 'Invoice/GetLookUpRV';
            $('#lookup_div_pvd_settlement').dialog({ title: 'Invoice List' });
        ...
        settlement_detail = $('#lookup_table_pvd_settlement_pr_detail');
            ...
            if (idMaster) {
                ...
                if (idDetail) {
                    ...
                    $('#txtPVDrefno').val(retDetail.invoiceno).data('refid', idMaster).data('refdetailid', idDetail);
    ...
    jQuery("#lookup_table_pvd_settlement_pr").jqGrid({
        ...
        mtype: 'GET',
        //loadonce:true,
        colNames: ['InvoiceNo', 'Shipment No', 'Payment USD', 'Payment IDR'],
        colModel: [{ name: 'invoiceno', index: 'Id', width: 80, align: "center" },
        ...
        onSelectRow: function (id) {
            ...
            if (id) {
                var lookUpURL = base_url + 'Invoice/GetLookUpRVDetail';
    ...
    jQuery("#lookup_table_pvd_settlement_pr_detail").jqGrid({
        ...
        mtype: 'GET',
        //loadonce:true,
        colNames: ['InvoiceNo', 'Description', 'Amount USD', 'Remaining USD', 'Amount IDR', ' Remaining IDR', 'shipment no', 'shipment id', 'rate', 'exrateid',
                    'prmasteraccountid', 'prmasteraccountcode', 'prmasteraccountiname'],
        colModel: [{ name: 'invoiceno', index: 'invoiceno', width: 80, align: "center" },
    ...
    jQuery("#lookup_table_pvd_settlement_rv").jqGrid({
        ...
        colModel: [{ name: 'rvno', index: 'invoiceno', width: 80, align: "center" },
                  { name: 'shipmentno', index: 'shipmentno', width: 200 },
                  { name: 'paymentusd', index: 'paymentusd', width: 100, align: "right", formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0.00' } },
                  { name: 'paymentidr', index: 'paymentidr', width: 100, align: "right", formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0.00' } }
        ],
    ...
    function ValidateViewReceiptVoucherDetail() {
        var isValid = true;
    ...
    $('#btn_add_payment_voucher_detail').click(function () {
        ...
        var isValid = ValidateViewReceiptVoucherDetail();
        if (isValid) {
    ...
    $('#lookup_btn_add_payment_voucher_detail').click(function () {
        ...
        if (!$('#rbSettlementForGeneral').is(':checked') && $.trim($('#txtPVDrefno').val()) == "") {
            ...
            var submitURL = (PVId != undefined && PVId != "") ? (pvDetailEdit == 0) ? base_url + "ReceiptVoucher/InsertDetail" : base_url + "ReceiptVoucher/UpdateDetail" : "";
            var isValid = true;
            var message = "OK";
            SavePVDetail(submitURL, pvDetailId, $('#txtPVDrefshipmentno').val(), $('#txtPVDaccountcode').data('kode'), $('#txtPVDaccountdesc').val(), dcnote,
                ...
                $('#txtPVDrefrate').numberbox('getValue'), $('#txtPVDrefrate').data('kode'), $('#txtPVDrefshipmentno').data('kode'), function (result) {
                    if (JSON.stringify(result.Errors) != '{}') {
                        ...
                        AddPaymentDetail(pvDetailEdit, result.Id, $('#txtPVDaccountcode').data('kode'), $('#txtPVDaccountcode').val(), $('#txtPVDaccountname').val(),
    ...
    function SavePVDetail(submitURL, v_pvDetailId, v_shipmentNo, v_accountId, v_desc, v_dcnote, v_amountUsd, v_amountIdr,
        ...
        if (submitURL != undefined && submitURL != "") {
            $.ajax({
                ...
                url: submitURL,
                data: JSON.stringify({
                    ReceiptVoucherId: PVId, Id: v_pvDetailId,
                    ShipmentNo: v_shipmentNo, ReceivableId: v_refDetailId, Description: v_desc, DCNote: v_dcnote,
    ...
    $('#btn_save_cash').click(function () {
        ...
        if (id) {
            ...
            var submitURL = (PVId != undefined && PVId != "") ? base_url + "ReceiptVoucher/UpdatePVDetail" : "";
            var isValid = true;
            var message = "OK";
    ...
    // Payment Voucher Detail
    function PopulateReceiptVoucherDetail() {
        var pvDetail = [];
        var data = $("#table_payment_voucher_detail").jqGrid('getGridParam', 'data');
        for (var i = 0; i < data.length; i++) {
            var obj = {};
    ...
    $('#lookup_btn_add_payment_voucher_detail_bank').click(function () {
        ...
        var submitURL = (PVId != undefined && PVId != "") ? (pvBankEdit == 0) ? base_url + "ReceiptVoucher/InsertPVBank" : base_url + "ReceiptVoucher/UpdatePVBank" : "";
        var isValid = true;
        var message = "OK";
            ...
            if (r) {
                ...
                if (PVId != undefined && PVId != "") {
                    $.ajax({
                        contentType: "application/json",
                        type: 'POST',
                        url: base_url + 'ReceiptVoucher/DeletePVBank',
                        data: JSON.stringify({
                            Id: v_pvBankId
                        }),
                        async: false,
    ...
    function SaveAll() {
        ...
        var submitURL = base_url + "ReceiptVoucher/Insert";
        ...
        $.ajax({
            ...
            url: submitURL,
            data: JSON.stringify({
                Id: PVId, CashBankId: $('#txtPVbankcode').data('kode'),
                ContactId: $('#txtPVcustomer').data('kode'),
            }),
            success: function (result) {
                if (JSON.stringify(result.Errors) != '{}') {
                    for (var key in result.Errors) {
                    ...
                    window.location = base_url + "ReceiptVoucher/Detail?Id=" + result.receiptVoucherId;
                }
            }
        });
    }
    ...
    function PopulateReceiptVoucherDetailBank() {
        var pvDetailBank = [];
    ...
    $('#paymentvoucher_form_btn_print').click(function () {
        ...
        //$.ajax({
        //    dataType: "json",
        //    url: base_url + "paymentvoucher/GetReceiptVoucherInfo?Id=" + PVId,
        //    success: function (result) {
        //        if (result.isValid) {
    ...
    $('#btnDialogPrintYes').click(function () {
        ...
        $('#dialogPrint').dialog('close');
        window.open(base_url + "ReceiptVoucher/Print?Id=" + PVId + "&PrintedOn=" + dateprint);
    });

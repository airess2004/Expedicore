...
{
    public class TruckJobListController : Controller
    {
        private readonly static log4net.ILog LOG = log4net.LogManager.GetLogger("TruckJobListController");
        ...
        public dynamic Finish(string _search, long nd, int rows, int? page, string sidx, string sord, string filters = "")
        {

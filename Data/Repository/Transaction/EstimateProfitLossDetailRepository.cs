...
{ 
    public class EstimateProfitLossDetailRepository : EfRepository<EstimateProfitLossDetail>, IEstimateProfitLossDetailRepository 
    {
        ...
        public EstimateProfitLossDetail ConfirmObject(EstimateProfitLossDetail model)
        {
        ...
        public EstimateProfitLossDetail UnconfirmObject(EstimateProfitLossDetail model)
        {
